...
void BigInt::writeNumber(BigInt &n)
{
    string res = n.toString();
        cout << res<<" ";
}
...
/*
BigInt BigInt::Pow(BigInt &X,BigInt &Y, BigInt &mod)
{
	BigInt res(1), xx = X , yy = Y;
	BigInt temp1(2);
	BigInt one(1);
	BigInt zero(0);
...
BigInt BigInt::powm(BigInt a, BigInt k, BigInt n)
{
    BigInt res(1);
    //writeNumber(a);
    //writeNumber(k);
